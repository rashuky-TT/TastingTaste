 ...
 * Generated by TASTE/Kazoo on 2022-07-12 21:19:51
...
typedef struct _PI_Messages {
   ...
   union {
      asn1SccPITCH_SEQ getpitchvalue_param;
   } msg_data;
} PI_Messages;
...
typedef struct _RI_Messages {
   ...
   union {
      asn1SccPITCH_VALUE settargetpitch_param;
   } msg_data;
} RI_Messages;
...
void egse_PI_Poll(void)
{
   ...
   while (!retrieve_message_from_queue(egse_RI_queue_id,
      ...
      switch(message_received_type) {
         case i_SetTargetPitch:
            egse_RI_SetTargetPitch((asn1SccPITCH_VALUE *)msgcontent);
            break;
       default : break;
      }
   }
