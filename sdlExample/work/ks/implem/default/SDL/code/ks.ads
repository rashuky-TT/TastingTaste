...
with PitchTM;
use PitchTM;
with CPPEXAMPLE_DATAVIEW;
use CPPEXAMPLE_DATAVIEW;
...
package Ks with Elaborate_Body is
   ...
   --  Provided interface "SetTargetPitch"
   procedure SetTargetPitch(pitch: in out asn1SccPITCH_VALUE);
   pragma Export(C, SetTargetPitch, "ks_PI_SetTargetPitch");
   --  Required interface "GetPitchValue"
   procedure RI_0_GetPitchValue (pitchData : in out asn1SccPITCH_SEQ) renames Ks_RI.GetPitchValue;
