...
ERR_PITCH_VALUE:constant Integer := 1; 
...
ERR_RESOLUTION:constant Integer := 6; 
...
ERR_VALIDITY:constant Integer := 11; 
...
ERR_PITCH_SEQ:constant Integer := 46; 
ERR_PITCH_SEQ_PITCHVAL_2:constant Integer := 21; 
ERR_PITCH_SEQ_RES_2:constant Integer := 31; 
ERR_PITCH_SEQ_VALI_2:constant Integer := 41; 
